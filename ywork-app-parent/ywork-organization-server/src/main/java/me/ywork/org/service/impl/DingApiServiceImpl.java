...
public class DingApiServiceImpl  implements IDingApiService {
	...
	//获取部门
	@Override
	public JSONObject getDingDeptList(DingSuiteThirdForSync suitethird) {
