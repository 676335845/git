package me.ywork.org.realtime.constants;
...
public class DingApiConstants {
	...
	//获取部门详情
	public static String GET_DEPT_DETAIL = "https://oapi.dingtalk.com/department/get?access_token=ACCESS_TOKEN&id=DEPTID";
