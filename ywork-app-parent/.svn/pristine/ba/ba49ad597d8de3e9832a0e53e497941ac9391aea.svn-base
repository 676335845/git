 ...
 * 薪资条主表
 */
public class SalaryBillModel implements Serializable {
	...
	private String columnName;	//可变列名（原来固定为总计列）
	
	private String title;//通知标题
	private String signs;//模板自定义标语
	
	private List<SalaryBillItemModel> salaryItems;
	...
	public List<SalaryBillItemModel> getSalaryItems() {
		return salaryItems;
	}

	public void setSalaryItems(List<SalaryBillItemModel> salaryItems) {
