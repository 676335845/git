...
public class SalStaffAttenDayModel implements Serializable{
	   /**
	 * 
	 */
	private static final long serialVersionUID = -5659906416847658490L;
	/**
	 * 主键ID
	 */
	   private String id;
	/**
	    ...
	    * 员工自定义请假的天数
	    */
	   private Double fieldDay;
		public SalStaffAttenDayModel() {
			super();
		}
		...
		public Double getFieldDay() {
			return fieldDay;
		}
		public void setFieldDay(Double fieldDay) {
